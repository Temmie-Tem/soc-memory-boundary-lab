...
|---:|---|---|---|---|
| 1 | Route-2 termination challenge | Try to falsify the claim that 029–034 leave no reachable, source-pinned transform-register writer in their bounded models, and check for contradictions with the repaired rank-3 relation. | Host-only read-only review using `docs/CODEX_HANDOFF_ROUTE2_TERMINATION_2026-08-27.md` and `docs/ROUTE2_TERMINATION_RESPONSE_2026-08-27.md`; any exact reachable writer, moving map, non-injective map, or ≥512-MiB proved contiguous ordinary pool reopens the route. | `PRIMARY CHALLENGE / Q4 UNKNOWN / NOT A CONSENSUS GATE` |
