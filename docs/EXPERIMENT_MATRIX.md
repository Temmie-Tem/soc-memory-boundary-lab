...
a separate audit and remains unpromoted. Verification 018 now supplies the
repaired/reacquired non-secure allocation-local storage-identity baseline; the
next selected work is the V017 audit plus the route-2 challenge. Experiment 035
remains deferred.
