...
bounded DCB consumer/writer complement. It binds the exact XBL plus
...
`[0x1489f9e8,0x1489fbe8)` and readers
...
exact-bound contract/gates. Class C and 015/016 eligibility remain unchanged.
