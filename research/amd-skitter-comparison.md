...
| Normal-world visibility | `PROVED`: PoC reads PCI config state | `PROVED`: host-visible XBL diagnostic formula; fixed direct EL1 SHRM snapshot read returned no value and watchdog-reset. Other secure export paths `UNKNOWN` |
