...
class A90IcbRemapperSnapshotTests(unittest.TestCase):
    ...
    def test_full_commands_cover_only_proved_layout(self) -> None:
        ...
        addresses = [int(command.argv[3], 16) for command in commands]
