...
class ExactArtifactTests(unittest.TestCase):
    ...
    def test_manifest_uses_the_suffix_experiment_id_and_static_dod_fields(self):
        self.assertEqual(self.manifest["experiment_id"], coverage.EXPERIMENT_ID)
        ...
        self.assertIn("022a", dod["commands"]["command"])
    ...
    def test_counts_are_scoped_and_known_counterexample_refutes_completeness(self):
        ...
        self.assertEqual(
            self.manifest["completeness_conclusion"]["global_project_nameable_set"],
            "UNKNOWN",
        )
