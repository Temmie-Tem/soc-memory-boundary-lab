...
EXPERIMENT_ID = "021A-dcb-delivery-paths"
...
def static_definition_of_done() -> dict:
    ...
    return {
        ...
        "commands": {
            ...
            "command": "python3 tools/sm8150_dcb_delivery_paths_021a.py --output <public-manifest-path>",
            "reason": (
                "Private input and output paths are redacted; exact firmware and "
                "dependency hashes are pinned in the manifest. This template is "
    ...
    return {
        ...
        "claims": {
            "PROVED": [
                ...
                "The embedded SHRM Xtensa blob holds exact aligned stored literals inside "
                "the first ranked MC instance block, and none equal to any of the twelve "
                "ranked target addresses; computed or received pointers remain UNKNOWN.",
            ...
            "UNKNOWN": [
                ...
                "the exact-literal result does not cover computed or received pointers.",
